                        ...
                        <form action="{{route('subjects.add')}}" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="subjectname" name="subjectname" class="form-control" required autofocus/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline"><input type="radio" name="subjecttype" value="Theory" checked>Theory</label>
                                    <label class="radio-inline"><input type="radio" name="subjecttype" value="Practical">Practical</label>
                                </div>
                            </div>
...
{{--                                                <a href="{{url('/subjects/delete/'.encrypt($subject->id))}}"><button class=" btn btn-warning" title="Delete subject" onclick="return confirmDelete()"><i class="fa fa-trash"></i> Delete</button></a>--}}
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
