                ...
                <div class="col-md-12">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-search"></i> Promote students</h3>
                        </div>
                        <form action="{{route('promotestudents.add')}}" method="post">
                            <div class="box-body">
                                ...
                                @endif
                                <div class="form-group col-md-4">
                                    <label for="classtopromote">Class to promote</label><small class="req"> *</small>
                                    <input type="text" id="classtopromote" name="classtopromote" class="form-control" required readonly/>
                                </div>
                                <div class="container col-md-12">
                                    <h3 style="margin: 0 0 10px 0; text-align: center;">Select students to promote</h3>
                                    <div class="row">
                                        <div class="col-md-5">
...
<script>
    $('#classname').change(function(){
        ...
        else if(classname == 10 || classname.substr(0,2) == 12){
            alert('Can not promote students');
            $('#sectionname').prop('disabled',true);
            $('#submitbtn').prop('disabled',true);
        }
        else{
            $('#classtopromote').val((parseInt(classname.substr(0,2))+1)+(classname.substr(2,9)));
            $('#sectionname').prop('disabled',false);
            $('#submitbtn').prop('disabled',false);
        }
        $.ajax({
