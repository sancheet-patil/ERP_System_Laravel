                ...
                <div class="col-md-12">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-search"></i> Search Bonafide Report</h3>
                        </div>
                        <form method="post" action="{{route('studentbonafidereport.post')}}">
                            <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover" id="student_table">
                                    ...
                                    $srno = 1;
                                    ?>
                                    @foreach($bonafidelist as $student)
                                        <tr>
                                            <td>{{$srno}}</td>
                        ...
                        <div class="box-footer">
                            @if($bonafidelist != '[]')
                                <a href="{{url('bonafidereportexcel')}}?academicyear={{$academicyear}}&registerfor={{$registerfor}}&classname={{$classname}}&faculty={{$faculty}}" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Report Print</a>
                            @endif
                        </div>
                    </div>
                </div>
