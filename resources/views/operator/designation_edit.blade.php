            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-default">
                        ...
                        <form action="{{route('designation.editdesignation')}}" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input type="text" id="id" name="id" class="form-control" required value="{{$designation->id}}"/>
                                </div>
                                <div class="form-group">
                                    <label for="designation">Designation Name </label><small class="req"> *</small>
                                    <input type="text" id="designation" name="designation" class="form-control" required autofocus value="{{$designation->designation}}"/>
                                </div>
                            </div>
