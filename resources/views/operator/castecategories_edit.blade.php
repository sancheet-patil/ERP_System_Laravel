    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('castecategories')}}">Caste Categories</a></li>
                <li class="active">Edit Caste Category</li>
            </ol>
        </section>
                ...
                <div class="col-md-4">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Caste Category</h3>
                        </div>
                        <form action="{{route('castecategory.editcastecategory')}}" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input type="text" id="id" name="id" class="form-control" required value="{{$castecategory->id}}"/>
                                </div>
                                    ...
                                    <select class="form-control select2" id="religion" name="religion" style="width:100%;" required autofocus>
                                        ...
                                        @if(isset($religions))
                                            @foreach($religions as $religion)
                                                <option value="{{$religion->id}}" @if($religion->id == $castecategory->religion) selected @endif>{{$religion->religion}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                    ...
                                    <select class="form-control select2" id="category" name="category" style="width:100%;" required>
                                        ...
                                        @if(isset($categories))
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}" @if($category->id == $castecategory->category) selected @endif>{{$category->category}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="castename" name="castename" class="form-control" required value="{{$castecategory->castename}}"/>
                                </div>
                                <div class="form-group">
                                    <label for="subcaste">Sub Caste name</label><small class="req"> *</small>
                                    <input type="text" id="subcaste" name="subcaste" class="form-control" required value="{{$castecategory->subcaste}}"/>
                                </div>
                            </div>
