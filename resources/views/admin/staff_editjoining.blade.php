    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('staff.joining')}}">Staff joining</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-warning">
                        <form action="{{route('staff.editjoining.edit')}}" method="post" enctype="multipart/form-data">
                            <div class="box-body">
