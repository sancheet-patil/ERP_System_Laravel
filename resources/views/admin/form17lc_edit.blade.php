            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <form action="{{route('form17lc.editlc')}}" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="dateofpassing" name="dateofpassing" class="form-control" required value="{{$lc->dateofpassing}}"/>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="examseatno">Exam Seat No.</label><small class="req"> *</small>
                                    <input type="text" id="examseatno" name="examseatno" class="form-control" required value="{{$lc->examseatno}}"/>
                                </div>
                            </div>
