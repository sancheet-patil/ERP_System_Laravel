            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <form method="post" action="{{route('form17lcissuereport.post')}}">
                            <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <div class="box-footer">
                            @if($lclist != '[]')
                                <a href="{{url('form17lcissuereportexcel')}}?academicyear={{$academicyear}}&registerfor={{$registerfor}}&classname={{$classname}}&faculty={{$faculty}}" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Report Print</a>
                            @endif
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('#registerfor').change(function () {
        ...
        if(registerfor === 'College Form 17') {
            document.getElementById("facultydiv").style.display = "block";
        }
        else {
            document.getElementById("facultydiv").style.display = "none";
