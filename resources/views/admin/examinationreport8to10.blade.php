                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="classname" name="classname" class="form-control select2" required>
                                        ...
                                        @foreach($classlist as $class)
                                            @if($class->classname >= '08' && $class->classname <= '10')
                                    ...
                                    @if(isset($studentlist))
                                        @foreach($studentlist as $student)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($check)
                                                        <a href="{{url('examinationreportprint8to10')}}?studentid={{$student->userid}}&semester={{$semester}}" class="btn btn-primary"><i class="fa fa-check"></i> Print report</a>
                                                    @else
