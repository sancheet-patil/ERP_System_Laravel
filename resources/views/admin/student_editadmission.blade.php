                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id="registerno" name="registerno" class="form-control" value="{{$studentdetails->registerno}}" required />
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id="mothertongue" name="mothertongue" value="{{$studentdetails->mothertongue}}" class="form-control" />
                                        </div>
                                        <div class="form-group col-md-3">
