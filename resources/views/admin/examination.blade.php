            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <form method="post" action="{{route('examination.post')}}">
                            <div class="box-body">
                                    ...
                                    @if(isset($studentlist))
                                        @foreach($studentlist as $student)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('examinationmark')}}?studentid={{$student->userid}}&semester={{$semester}}" class="btn btn-primary"><i class="fa fa-check"></i> Set marks</a>
                                                </td>
                                            </tr>
                                            <?php $srno++;?>
                                        @endforeach
