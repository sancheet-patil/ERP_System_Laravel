<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
        <a href="{{'#'}}" class="sidebar-toggle" data-toggle="push-menu" role="button">
            ...
            <span style="margin-left: 20px; font-size: 14px;">{{config('app.name')}}</span>
        </a>
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="#" data-toggle="control-sidebar">Active year: {{\Illuminate\Support\Facades\Session::get('academicyear')}}</a>
                </li>
                <li>
                    <a href="#" data-toggle="control-sidebar">Active registration: {{\Illuminate\Support\Facades\Session::get('registerfor')}}</a>
                </li>
                <li class="dropdown user user-menu">
                    <a href="{{'#'}}" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{asset('images/profile.png')}}" class="user-image" alt="User Image">
