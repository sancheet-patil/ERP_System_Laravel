                        ...
                        <form action="{{route('holiday.add')}}" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="hdate" name="hdate" class="form-control" required autofocus/>
                                </div>
                                <div class="form-group">
...
{{--                                                <a href="{{url('/holiday/delete/'.encrypt($holiday->id))}}"><button class=" btn btn-warning" title="Delete holiday" onclick="return confirmDelete()"><i class="fa fa-trash"></i> Delete</button></a>--}}
                                            </td>
                                        </tr>
                                        <?php $srno++;?>
                                    @endforeach
