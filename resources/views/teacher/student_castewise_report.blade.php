            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <form method="post" action="{{route('castewisestudentreport.post')}}">
                            <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <div class="box-footer">
                            @if($studentlist != '[]')
                                <a href="{{url('castewisestudentreportexcel')}}?academicyear={{$academicyear}}&registerfor={{$registerfor}}&classname={{$classname}}&division={{$division}}&gender={{$gender}}&religion={{$religion}}&castename={{$castename}}&subcaste={{$subcaste}}&fname={{$fname}}&mname={{$mname}}&lname={{$lname}}" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Report Print</a>
                            @endif
                        </div>
                    </div>
                </div>
