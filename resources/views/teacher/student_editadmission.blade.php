    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('student.admission')}}"> Student Admission</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-warning">
                        ...
                        <form action="{{route('student.editadmission.edit')}}" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select id="academicyear" name="academicyear" class="form-control select2" required readonly>
                                                <option value="">Select</option>
                                                <?php
                                                $academicyears = \App\AcademicYearList::orderBy('academicyear','desc')->get();
                                                ?>
                                                @foreach($academicyears as $academicyear)
                                                    <option value="{{$academicyear->academicyear}}" @if($academicyear->academicyear == $studentdetails->academicyear)) selected @endif>{{$academicyear->academicyear}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3" id="facultydiv" style="@if(!$studentdetails->faculty) display:none; @endif">
                                            ...
                                            <select id="faculty" name="faculty" class="form-control" readonly >
                                                <option value="">Select</option>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select id="classname" name="classname" class="form-control select2" required readonly>
                                                <option value="">Select</option>
                                                <?php
                                                $classlist = \App\ClassLists::orderBy('classname','asc')->get();
                                                ?>
                                                @foreach($classlist as $class)
                                                    <option value="{{$class->classname}}" @if($class->classname == $studentdetails->classname) selected @endif>{{$class->classname}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id="lname" name="lname" class="form-control" value="{{$studentdetails->lname}}" required readonly/>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="fname">First name</label> <small class="req"> *</small>
                                            <input type="text" id="fname" name="fname" class="form-control" value="{{$studentdetails->fname}}" required readonly/>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="mname">Middle name</label>
                                            <input type="text" id="mname" name="mname" class="form-control" value="{{$studentdetails->mname}}" readonly />
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id="mothertongue" name="mothertongue" value="{{$studentdetails->mothertongue}}" class="form-control" readonly />
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="placeob" name="placeob" class="form-control" value="{{$studentdetails->placeob}}" required readonly/>
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" id="lastclass" name="lastclass" class="form-control" required readonly value="{{$studentdetails->lastclass}}"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-3" id="lastschooldiv" style="@if('Other' != $studentdetails->schoolname) display: none; @endif">
                                            ...
                                            <input type="text" id="lastschool" name="lastschool" class="form-control" required readonly value="{{$studentdetails->lastschool}}"/>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="previouslcno">Previous LC Number</label> <small class="req"> *</small>
                                            <input type="text" id="previouslcno" name="previouslcno" class="form-control" required readonly value="{{$studentdetails->previouslcno}}"/>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="previousgrno">Previous Registration Number</label><small class="req"> *</small>
                                            <input type="text" id="previousgrno" name="previousgrno" class="form-control" required readonly value="{{$studentdetails->previousgrno}}"/>
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-6" id="pwddiv" style="@if($studentdetails->pwd == 'No') display: none; @endif">
                                            ...
                                            <input type="text" id="pwd" name="pwd" class="form-control" required readonly value="{{$studentdetails->pwd}}"/>
                                        </div>
                                        <div class="form-group col-md-3">
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <label class="radio-inline"><input type="radio" id="guardianis" name="guardianis" value="Father" required readonly @if('Father' == $studentdetails->guardianrelation) checked @endif>Father</label>
                                            <label class="radio-inline"><input type="radio" id="guardianis" name="guardianis" value="Mother" required readonly @if('Mother' == $studentdetails->guardianrelation) checked @endif>Mother</label>
                                            <label class="radio-inline"><input type="radio" id="guardianis" name="guardianis" value="Other" required readonly @if('Other' == $studentdetails->guardianrelation) checked @endif>Other</label>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="guardianname">Guardian Name</label><small class="req"> *</small>
                                            <input type="text" id="guardianname" name="guardianname" class="form-control" value="{{$studentdetails->guardianname}}" required readonly/>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="guardianphone">Guardian Phone</label><small class="req"> *</small>
                                            <input type="number" id="guardianphone" name="guardianphone" class="form-control" value="{{$studentdetails->guardianphone}}" required readonly/>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="guardianrelation">Guardian Relation</label><small class="req"> *</small>
                                            <input type="text" id="guardianrelation" name="guardianrelation" class="form-control" value="{{$studentdetails->guardianrelation}}" required readonly/>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="guardianoccupation">Guardian Occupation</label><small class="req"> *</small>
                                            <input type="text" id="guardianoccupation" name="guardianoccupation" class="form-control" value="{{$studentdetails->guardianoccupation}}" required readonly/>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="guardianaddress">Guardian Address</label><small class="req"> *</small>
                                            <input type="text" id="guardianaddress" name="guardianaddress" class="form-control" value="{{$studentdetails->guardianaddress}}" required readonly/>
                                        </div>
                                    </div>
                                </div>
                            </div>
