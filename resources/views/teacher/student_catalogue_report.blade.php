            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <form method="post" action="{{route('studentcataloguereport.post')}}">
                            <div class="box-body">
                ...
                <div class="col-md-12">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-search"></i> Student catalogue report</h3>
                        </div>
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            @if($srno!=1 && $classname)
                                <a href="{{url('studentcataloguereportexcel')}}?classname={{$classname}}" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Report Print</a>
                            @endif
                        </div>
                    </div>
                </div>
