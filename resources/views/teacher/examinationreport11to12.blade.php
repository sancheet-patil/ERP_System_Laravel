            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <form method="post" action="{{route('examinationreport8to10.post')}}">
                            <div class="box-body">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="classname" name="classname" class="form-control select2" required>
                                        ...
                                        @foreach($classlist as $class)
                                            @if($class->classname == '11' || $class->classname == '12')
                                    ...
                                    @if(isset($studentlist))
                                        @foreach($studentlist as $student)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($check)
                                                        <a href="{{url('examinationreportprint11to12')}}?studentid={{$student->userid}}&semester={{$semester}}" class="btn btn-primary"><i class="fa fa-check"></i> Print report</a>
                                                    @else
