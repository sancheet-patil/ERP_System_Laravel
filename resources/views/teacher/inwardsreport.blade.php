    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Inwards report</li>
            </ol>
        </section>
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        ...
                        <form method="post" action="{{route('inwardsreport.post')}}">
                            <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-search"></i> Inwards Report</h3>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover" id="student_table">
                                    ...
                                    @if(isset($inwardslist))
                                        @foreach($inwardslist as $content)
                                            <tr>
                                                <td>{{$srno}}</td>
                                                <?php $srno++;?>
                                                <td>{{$content['fromtitle']}}</td>
                            ...
                            @if(isset($inwardslist))
                                @if($inwardslist != '[]')
                                    <span class="pull-right">
                                        <a href="{{url('inwardsreportexcel')}}?month={{$month}}&year={{$year}}" class="btn btn-primary" target="_blank"><i class="fa fa-book"></i> Report</a>
                                    </span>
                                @endif
                            @endif
                        </div>
